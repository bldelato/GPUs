...
/*
 * Traspose CUDA 2D version
 */
/*
__global__ void transpose_device_2D(float *in, float *out, int rows, int cols) 
{ 
	int i, j;
...
/*
 * Traspose CUDA 2D version with Shared Memory
 */

#define TILE_DIM NTHREADS2D
...
int main(int argc, char **argv)
{
	...
	*/
	...
	t0 = getMicroSeconds();
	transpose_device_2D<<<dimGrid,dimBlock>>>(darray1D, darray1D_trans, n, n);	
